...
%------------------------------------------------
\begin{frame}{Illustration: Simple Attribute}
\centering
\imageplaceholder{simple-attribute.png}{Simple Attribute in the ER Model}
\end{frame}
...
\centering
\imageplaceholder{composite-attribute.png}{Composite Attribute in the ER Model}
\end{frame}
...
\centering
\imageplaceholder{multivalued-attribute.png}{Multivalued Attribute in the ER Model}
\end{frame}
...
\centering
\imageplaceholder{derived-attribute.png}{Derived Attribute in the ER Model}
\end{frame}
...
\centering
\imageplaceholder{relationship-set.png}{Relationship type and relationship set}

\vspace{2mm}
{\small Figure 5. Relationship type and relationship set.}
\end{frame}
...
\centering
\imageplaceholder{recursive-relationship.png}{Unary or Recursive Relationship}
\end{frame}
