...
- [MySQL INNER JOIN](https://www.mysqltutorial.org/mysql-basics/mysql-inner-join/)
- [MySQL LEFT JOIN](https://www.mysqltutorial.org/mysql-basics/mysql-left-join/)
- [MySQL RIGHT JOIN](https://www.mysqltutorial.org/mysql-basics/mysql-right-join/)
- [MySQL SELF JOIN](https://www.mysqltutorial.org/mysql-basics/mysql-self-join/)
- [MySQL CROSS JOIN](https://www.mysqltutorial.org/mysql-basics/mysql-cross-join/)
